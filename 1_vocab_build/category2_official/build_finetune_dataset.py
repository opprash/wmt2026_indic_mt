...
TAGIN_TRAIN  = r"C:\Users\Administrator\Desktop\智能2026\个人\wmt2026\code\tagin\targin_train.json"
TAGIN_TEST   = r"C:\Users\Administrator\Desktop\智能2026\个人\wmt2026\code\tagin\targin_test.json"
...
# 语种 → Excel 文件名（处理 "English-X" / "English - X" 命名差异）
EXCEL_FILES = {
    "Karbi":    "English - Karbi Training Data 2026.xlsx",
    "Bodo":     "English-Bodo Training Data 2026.xlsx",
    "Kokborok": "English-Kokborok Training Data 2026.xlsx",
    "Nagamese": "English-Nagamese  Training Data 2026.xlsx",
    "Tagin":    "English-Tagin Training Data 2026.xlsx",
}
...
def main():
    ...
    ap.add_argument("--force-excel", action="store_true",
                    help="ignore existing tagin/*.json and re-split from Excel")
    args = ap.parse_args()
    ...
    # 数据源
    if lang == "Tagin" and not args.force_excel \
            and os.path.exists(TAGIN_TRAIN) and os.path.exists(TAGIN_TEST):
        print(f"Source: existing JSON ({TAGIN_TRAIN})")
        train_pairs, test_pairs = load_pairs_from_existing_json(TAGIN_TRAIN, TAGIN_TEST)
    else:
